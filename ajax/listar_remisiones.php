...
try {
    ...
    $stmt = $remision->obtenerRemisionesPaginadas($busqueda, $fecha, '', $offset, $registros_por_pagina);

    // Como la función original devuelve un statement, hacemos fetchAll aquí
